...
public class FarmApp {
                ...
                try {
                    ...
                    switch (farmChoice) {
                        ...
                        case "5":
                            ...
                            System.out.println(
                                    farm.getShedList().get(shedIndex).getHerd().get(index).printAnimalDetails());
                                    ...
                                    for (Animal animal : herd) {
                                        if (animal instanceof DairyCow) {
                                            if (shed.getMilkingMachine().getCowMilkTank() == null) {
                                                ...
                                                System.out
                                                        .println("    Milk Tank installed in " + shed.getId() + " for "
                        ...
                        case "13":
                            ...
                            if (systemChoice.equals("1")) {
                                System.out.println("\n>>> Dairy Cows sorted by Milk Production");
    ...
    public static Farm manualAddFarm() {
        ...
        try {
            ...
            System.out.print("\nPlease enter the farm ID: ");
            String farmName = sc.nextLine();
            System.out.print("\nPlease enter the owner name: ");
            String ownerName = sc.nextLine();
            System.out.print("\nPlease enter the number of sheds: ");
            ...
            if (numberOfSheds > 0) {
                ...
                for (int i = 0; i < numberOfSheds; i++) {
                    ...
                    System.out.print("\nPlease enter the shed name: ");
                    String shedName = sc.next();
                    shedList.add(new Shed(shedName));

                    System.out.println("\n*** Types of animals in Shed ***");
                    farm.avaiableAnimalTypes();

                    System.out.print("\nPlease enter the number for Types of animals in Shed: ");
                    ...
                    for (int j = 0; j < numberOfAnimals; j++) {
                        ...
                        switch (animalType) {
                            case "1":
                                ...
                                System.out.print("\nPlease enter the number of Dairy Cows: ");
                                int numberOfDairyCows = sc.nextInt();

                                for (int k = 0; k < numberOfDairyCows; k++) {
                                    System.out.print("\nPlease enter the name of the Dairy Cow: ");
                                    String name = sc.next();
